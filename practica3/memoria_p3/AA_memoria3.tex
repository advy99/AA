...
Debido a que estamos en un problema de regresión la métrica de evaluación será el error cuadrático medio, es decir, que a mayor distancia de los datos con nuestro ajuste, mayor será el error.
