...
Otra razón es que el problema ya tiene un gran número de dimensiones

\subsection{Conjuntos de training y test.}


Como vimos en la introducción del problema, podemos comprobar que efectivamente cada dato tiene 64 variables:

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.7]{clasificacion/num_datos.png}
	\caption{Información sobre los datos.}
